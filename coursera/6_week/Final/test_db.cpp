...
string Entry (Date date, string event)
{
  ostringstream os;
  os << date << " " << event;
  return os.str ();
...
void TestDbFind ()
{
  ...
  }
  {
    ...
    db.Add ({2017, 1, 7}, "xmas");
    AssertEqual ("2017-01-01 new year\n2017-01-07 xmas\n2",
                 DoFind (db, R"(date == 2017-01-07 OR event == "new year")"),  "complex find or");
    AssertEqual ("2017-01-01 new year\n1",
                 DoFind (db, R"(date == 2017-01-01 AND event == "new year")"), "complex find and");
...
void TestDatabase ()
{
  ...
  // Add
  {
    ...
    db.Add (d, "e1");
    AssertEqual (db.FindIf (empty_predicate).size (), static_cast<long unsigned int> (2), "Db Add2-Del-Add 2");
  }
  {
    Database db;
    Date d (2019, 1, 1);
    ...
    AssertEqual (db.FindIf (predicate).size (), static_cast<long unsigned int> (1), "Db Add Duplicates 1");
  }
  ...
  // Find
  {
    ...
    AssertEqual(db.FindIf(predicate).size (), static_cast<long unsigned int> (2), "Db Find 1");
  }
  {
    Database db;
    db.Add ({2019, 1, 1}, "e1");
    ...
    AssertEqual (db.FindIf (predicate).size (), static_cast<long unsigned int> (4), "Db Find 2");
  }
  {
    Database db;
    db.Add ({2019, 1, 1}, "e1");
    ...
    db.Add ({2018, 1, 7}, "e3");
    db.Add ({2018, 1, 7}, "e4");
    AssertEqual (db.FindIf (empty_predicate).size (), static_cast<long unsigned int> (4), "Db Find 3");
  }
  {
    Database db;
    db.Add ({2019, 1, 1}, "e1");
    ...
    AssertEqual (db.FindIf (predicate).size (), static_cast<long unsigned int> (1), "Db Find 4");
  }
  {
    Database db;
    db.Add ({2019, 1, 1}, "e1");
    ...
    AssertEqual (db.FindIf (predicate).size (), static_cast<long unsigned int> (2), "Db Find 5");
  }
