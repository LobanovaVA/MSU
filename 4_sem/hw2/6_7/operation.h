...
public:
    ...
    int check_one_word_1symbol (char *readed_str, parser* S);
    int solve_6 (const char *a, const char *b, parser* S);

    int check_all_word_1symbol (char *readed_str, parser* S);
    int solve_7 (const char *a, const char *b, parser* S);
};
