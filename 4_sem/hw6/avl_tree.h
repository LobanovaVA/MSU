...
public:
        ...
        list_node * search    (avl_tree_node *curr, command &line);
        list_node * search_or (avl_tree_node *curr, command &line, list_node* &res_or);
        list_node * search_next_found    (avl_tree_node *curr, command &line, list_node *curr_found);
        list_node * search_next_found_or (avl_tree_node *curr, command &line, list_node *curr_found);
