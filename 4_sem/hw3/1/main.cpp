...
int main (int argc, char const *argv[])
{
    ...
    if ( !(argc == 4 && ( !(strcmp (argv[3],"0")) || (v = atoi (argv[3])) ) ) ) return printf("Usage: %s n (file_name) (element student s: name value)\n", argv[0]), 4;
    //if ( !(argc == 4 &&  (v = atoi (argv[3])) ) ) return printf("Usage: %s n (file_name) (element student s: name value)\n", argv[0]), 4;
