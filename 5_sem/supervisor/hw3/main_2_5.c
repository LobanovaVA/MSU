...
main (int argc, char *argv[])
{
  ...
  ret = problem_2_5 (a, b, eps, &x, mode);
  ...
  if (ret < SUCCESS)
    {
      switch(ret){
        case ERROR_NO_SOLUTION:
          ...
          break;
        case ERROR_NO_SOLUTION_M5_1:
          printf("ERROR: Root is not found - fabs (f (d)) > ...\n");
          break;
        case ERROR_NO_SOLUTION_M5_2:
          printf("ERROR: Root is not found - fabs (f (a)) > ...\n");
          break;
