...
bool cmp1 (list_node *x, list_node *y){ return *x < *y; }
bool cmp2 (list_node *x, list_node *y){ return *x > *y; }
...
int main (int argc, char const *argv[])
{
    ...
    switch (sort_type)
    {
        ...
        default: { printf ("Incorrect sorttype %d", sort_type); a.delete_list (); return 5; }
    }
