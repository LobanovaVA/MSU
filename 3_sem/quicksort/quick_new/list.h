...
//sort:
        ...
        {  
            int n = length();
            _quick_sort(head, nullptr, nullptr, n, cmp); 
            
        }
        void _quick_sort (list_node *first, list_node *end, list_node *prefirst, int len; bool (*cmp)(list_node *, list_node *));
...
//other:
        ...
        list_node * select_elem(list_node *first, list_node *end);
