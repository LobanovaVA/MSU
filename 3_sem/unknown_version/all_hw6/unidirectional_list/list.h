...
//sort:
        ...
        void quick_sort (bool (*cmp)(list_node*, list_node*)){  _quick_sort(head, nullptr, nullptr, cmp); }
        void _quick_sort (list_node *first, list_node *end, list_node *prefirst, bool (*cmp)(list_node *, list_node *));
